...
print("\nNew test types demonstrated:")
print("  - test_function_solution: Assignment 10")
print("  - check_relationship: Assignment 11")
print("  - check_function_any_line: Assignment 12")
print("  - check_multiple_lines: Assignment 12")
print("  - function_not_called: Assignments 10 & 12")