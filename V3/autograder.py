...
class AutoGrader:
    ...
    def check_variable_relationship(self, var1_name: str, var2_name: str, relationship: Callable, 
        ...
        Args:
            var1_name: Name of first variable (e.g., 'x')
            var2_name: Name of second variable (e.g., 'y')
            relationship: Function that takes var1 and returns expected var2
        ...
        try:
            ...
            # Compare using numpy's allclose for arrays, abs for scalars
